...
public class Rutina : MonoBehaviour
{
    ...
    private IEnumerator RutinaDeEnemigos()
    {
        ...
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize, 14), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        ...
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-12, ySize), Quaternion.identity);
        ...
        enemigoInstanciado.GetComponent<Enemigo1>().ColorEnemigo(ROJO);
        yield return new WaitForSeconds(2);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        ...
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-13, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-11, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-9, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-7, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-5, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-3, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-1, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(1, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(3, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(5, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(7, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(9, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(11, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(13, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        yield return new WaitForSeconds(2);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(13, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        ...
        enemigoInstanciado.GetComponent<Enemigo1>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("SquareEnemy", new Vector2(-xSize - 4, 10), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo1>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("SquareEnemy", new Vector2(-xSize - 6, 10), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo1>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(13, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(10, ySize), Quaternion.identity);
        ...
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(8, ySize), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-8, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-6, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-4, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(-2, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(0, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(2, ySize + 1), Quaternion.identity);
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(4, ySize + 1), Quaternion.identity);
        ...
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize, 13), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize, 13), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize, 11), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize, 11), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        yield return new WaitForSeconds(1);
        ...
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize - 1, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize + 1, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(8, ySize), Quaternion.identity);
        ...
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(ROJO);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize - 2, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize + 2, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(ROJO);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(13, ySize), Quaternion.identity);
        ...
        enemigoInstanciado.GetComponent<EnemigoC>().ColorEnemigo(AZUL);
        yield return new WaitForSeconds(1);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(-xSize - 3, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("TriangleEnemy", new Vector2(xSize + 3, 15), Quaternion.identity);
        enemigoInstanciado.GetComponent<Enemigo2>().ColorEnemigo(AZUL);
        enemigoInstanciado = ObjectsRepository.UseRepository("CircleEnemy", new Vector2(10, ySize), Quaternion.identity);
